 ...
 *
 * COPIED VERBATIM FROM `packages/react/test/mount.tsx`, which is where it was
 * written and where its reasoning belongs. Copied rather than imported across
 * the package boundary because a test helper is not part of either package's
 * surface, and copied rather than rewritten because two harnesses for the same
 * job is how two packages end up disagreeing about what `act` is for. Forty
 * lines of `react-dom/client` is the whole thing; if it grows, move it.
 *
